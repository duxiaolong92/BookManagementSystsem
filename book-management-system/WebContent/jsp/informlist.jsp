 ...
 %> &nbsp;&nbsp; </a>
	...
	<div id="content">
		...
		<div id="right_content">
			<div class="menu_box">
				<ul>
					<li id="one1" class="hover"><a href="#">通知公告列表</a>
					</li>
					<li id="one2" class=""><a
						href="/book-management-system/InformServlet?actionType=moreSource">资源动态列表</a>
					</li>
					<li id="one3" class=""><a
						href="/book-management-system/InformServlet?actionType=moreNews">新闻列表</a>
					</li>
				</ul>
			</div>
			<div id="inform_list" style="line-height: 30px;">
				<table class="table" width="700" border="0" cellspacing="0"
					...
					<tbody>
						...
						<tr>
							...
							<td class="left_col"><a
								href="/book-management-system/InformServlet?actionType=inform&informID=<%=inform.getInformID()%>"><%=inform.getTitle()%></a>
							</td>
						...
						<tbody>
							...
							<tr>
								...
								<div class="bg" onmouseover="this.className='bg_hover'" onmouseout="this.className='bg'" ><%
										out.print("<a href=/book-management-system/InformServlet?actionType=informPage&pageNow=1>1</a>");
									%></div>
								</td>
								...
								<td>
									<div class="bg" onmouseover="this.className='bg_hover'" onmouseout="this.className='bg'"><%
										out.print("<a href=/book-management-system/InformServlet?actionType=informPage&pageNow="
													+ (i + 1) + ">" + (i + 1) + "");
										}
									%></div>
								</td>
