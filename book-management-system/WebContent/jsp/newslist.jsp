		...
		<div id="right_content">
			<div class="menu_box">
                       <ul>
                          ...
                          <li id="one2" class=""><a href="/book-management-system/InformServlet?actionType=moreSource">资源动态列表</a></li>
                          <li id="one3" class="hover"><a href="#">新闻列表</a></li>
                                 </ul>
               </div>

		<div id="news_list" style="display: block;line-height: 30px;">
						...
						<tbody>
							...
							<tr>
								...
								<div class="bg" onmouseover="this.className='bg_hover'" onmouseout="this.className='bg'" ><%
										out.print("<a href=/book-management-system/InformServlet?actionType=newsPage&pageNow=1>1</a>");
									%></div>
								</td>
								...
								<td>
									<div class="bg" onmouseover="this.className='bg_hover'" onmouseout="this.className='bg'"><%
										out.print("<a href=/book-management-system/InformServlet?actionType=newsPage&pageNow="
													+ (i + 1) + ">" + (i + 1) + "");
										}
									%></div>
								</td>
